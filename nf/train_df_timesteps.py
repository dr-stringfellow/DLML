...
def train_diffusion_model(df_model, data_train, context_train, data_val, context_val, num_epochs=1000, noise_schedule=None, batch_size=512, learning_rate=1e-3, timesteps=300):
    ...
    for epoch in range(num_epochs):        
        ...
        torch.save(state_dicts, f'models_diffusion_timesteps/epoch-{epoch}.pt')
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.savefig("/web/bmaier/public_html/delight/df_timesteps/loss.png",bbox_inches='tight',dpi=300)
    plt.savefig("/web/bmaier/public_html/delight/df_timesteps/loss.pdf",bbox_inches='tight')
